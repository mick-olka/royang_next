    ...
    return (
        ...
        <div className={s.header}>
            ...
            <div className={s.header_text_div}>
                <p style={{fontSize: "1.2rem"}} >Some text about delivery</p>
            </div>
            ...
            <div className={s.cart_div}>
                <Link href="/order" passHref >
                    <a>
                    <Image className={s.cart_icon} width={40} height={40} src='/images/icons/laundry-basket_color.png' alt="cart_icon"/>
                    </a>
                </Link>
            </div>
        </div>
